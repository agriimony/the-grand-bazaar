  ...
  try {
    ...
    if (batchItems.length) {
      try {
        ...
        console.log('[world/degen] batch fetch start', { batchUrl, count: batchItems.length });
        ...
        console.log('[world/degen] batch fetch response', { status: br.status, ok: br.ok });
        ...
        console.log('[world/degen] batch fetch error', { error: e?.message || 'unknown' });
